"""
Data model definitions for the AI Assistant (cost estimation).
Dataclasses for Hospital, Procedure, and RiskCondition.
Tables must exist in Supabase — see create_tables.sql.
"""
